...
export default function NovaBeneficiaria() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (responsavelSelecionada?.id)   body.responsavel_id = responsavelSelecionada.id;
      ...
      const res = await fetchAuth(`${API_URL}/beneficiarias`, {
        method: "POST",
      ...
      setSubmitError(err instanceof Error ? err.message : "Erro ao cadastrar beneficiária.");
      setLoading(false);
    }
  }
    ...
    <div style={{ padding: "36px 32px", minHeight: "100vh" }}>
      ...
      <div style={{ marginBottom: "28px" }}>
        ...
        <p style={{ fontSize: "13px", color: "#6B5E54", marginTop: "4px" }}>
          Preencha os dados para cadastrar uma nova beneficiária na plataforma.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        >
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", marginBottom: "20px" }}>
            ...
            {/* Responsável — só para CRIANCA / ADOLESCENTE */}
            {precisaResponsavel ? (
